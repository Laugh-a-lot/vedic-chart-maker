...
function App() {
  ...
  // 10: { name: "A2", zodiac: "Gemini", rasi_no: 5, house: 8 },
  // 11: { name: "A3", zodiac: "Gemini", rasi_no: 5, house: 8 },
  // 12: { name: "A4", zodiac: "Gemini", rasi_no: 5, house: 8 },
  // 13: { name: "A5", zodiac: "Gemini", rasi_no: 5, house: 8 },
  // 15: { name: "A7", zodiac: "Gemini", rasi_no: 5, house: 8 },
  // 16: { name: "A8", zodiac: "Gemini", rasi_no: 5, house: 8 },
  // 18: { name: "A2", zodiac: "Gemini", rasi_no: 6, house: 8 },
  // 19: { name: "A3", zodiac: "Gemini", rasi_no: 9, house: 12 },
  // 20: { name: "A4", zodiac: "Gemini", rasi_no: 7, house: 6 },
  // 22: { name: "A7", zodiac: "Gemini", rasi_no: 7, house: 6 },
