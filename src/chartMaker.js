module.exports = (newjson, style, color) => {
    ...
    var houseAddresses = [
        [[240, 125], [210, 100], [280, 100], [210, 130], [280, 130], [210, 160], [280, 160], [245, 190], [245, 40]],
        [[60, 25], [100, 25], [140, 25], [180, 25], [80, 50], [120, 50], [160, 50], [120, 75], [25, 25]],
        [[10, 70], [10, 110], [10, 150], [10, 190], [50, 90], [50, 130], [50, 170], [50, 130], [10, 40]],
        [[120, 180], [80, 220], [160, 220], [80, 260], [160, 260], [80, 300], [160, 300], [120, 340], [150, 180]],

        [[10, 320], [10, 360], [10, 400], [10, 440], [50, 350], [50, 390], [50, 430], [80, 380], [10, 285]],
        [[60, 485], [100, 485], [140, 485], [180, 485], [80, 460], [120, 460], [160, 460], [120, 435], [30, 485]],
        [[245, 320], [210, 350], [280, 350], [210, 380], [280, 380], [210, 410], [280, 410], [245, 440], [245, 480]],
        [[470, 320], [470, 360], [470, 400], [470, 440], [440, 350], [440, 390], [440, 430], [410, 380], [470, 290]],

        [[300, 485], [340, 485], [380, 485], [420, 485], [335, 460], [375, 460], [415, 460], [375, 435], [275, 490]],
        [[375, 180], [335, 220], [415, 220], [335, 260], [415, 260], [335, 300], [415, 300], [375, 340], [470, 250]],
        [[470, 70], [470, 110], [470, 150], [470, 190], [440, 90], [440, 130], [440, 170], [410, 130], [470, 40]],
        [[300, 25], [340, 25], [380, 25], [420, 25], [335, 50], [375, 50], [415, 50], [375, 75], [275, 20]]
    ], rasiAddresses = [
        [[150, 40], [180, 40], [210, 40], [150, 80], [180, 80], [210, 80], [150, 120], [180, 120], [210, 120]],
        [[270, 40], [300, 40], [330, 40], [270, 80], [300, 80], [330, 80], [270, 120], [300, 120], [330, 120]],
        [[400, 40], [430, 40], [460, 40], [400, 80], [430, 80], [460, 80], [400, 120], [430, 120], [460, 120]],
        [[400, 160], [430, 160], [460, 160], [400, 190], [430, 190], [460, 190], [400, 210], [430, 210], [460, 210]],
        [[400, 280], [430, 280], [460, 280], [400, 310], [430, 310], [460, 310], [400, 340], [430, 340], [460, 340]],
        [[400, 410], [430, 410], [460, 410], [400, 440], [430, 440], [460, 440], [400, 470], [430, 470], [460, 470]],
        [[270, 410], [300, 410], [330, 410], [270, 440], [300, 440], [330, 440], [270, 470], [300, 470], [330, 470]],
        [[150, 410], [180, 410], [210, 410], [150, 440], [180, 440], [210, 440], [150, 470], [180, 470], [210, 470]],
        [[25, 410], [55, 410], [85, 410], [25, 440], [55, 440], [85, 440], [25, 470], [55, 470], [85, 470]],
        [[25, 280], [55, 280], [85, 280], [25, 310], [55, 310], [85, 310], [25, 340], [55, 340], [85, 340]],
        [[25, 160], [55, 160], [85, 160], [25, 190], [55, 190], [85, 190], [25, 210], [55, 210], [85, 210]],
        [[25, 40], [55, 40], [85, 40], [25, 80], [55, 80], [85, 80], [25, 120], [55, 120], [85, 120]],
    ], rasi_no = [1, 2, 3, 4, 4, 5, 6, 7, 8, 9, 10, 11, 12], new_rasi_no = []
...
console.log(house, "house")
    house.forEach((element, ind) => {
        element.forEach((houseelem, Hindex) => {
            ...
            svgStringHouse = svgStringHouse + `<text x="${houseAddresses[ind][Hindex][0]}" y= "${houseAddresses[ind][Hindex][1]}" style = "font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;display: flex;justify-content: center;align-items: center;color:rgb(83, 83, 83);font-weight:bold ">${houseelem}</text>`
    ...
    rasi.forEach((element, ind) => {
        element.forEach((houseelem, Hindex) => {
            ...
            svgStringRasi = svgStringRasi + `<text x="${rasiAddresses[ind][Hindex][0]}" y= "${rasiAddresses[ind][Hindex][1]}" style = "font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;display: flex;justify-content: center;align-items: center;color:rgb(83, 83, 83)${isBold ? ";font-weight:bold" : ""} ">${houseelem}</text>`
